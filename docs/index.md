...
- **[Compile-time Agent Skills](compile-skills.md)** — `SKILL.md` discovery, `.akc/project.json` keys, and Cursor-compatible layout.
- **[Architecture](architecture.md)** — High-level flow and component roles.
- **[Ops Runbook](ops-runbook.md)** — Control-bot deployment, secrets, policy and incident operations.
